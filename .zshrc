...
alias tell="tgpt -m"
alias contin="lobster -c"
alias ani="jerry -i --dub"
alias ani='~/jerry.sh'
...
export PATH=$PATH:"mnt\c\Users\aryan\scoop\apps\mpv\0.36.0"
export PATH="$PATH:/mnt/c/Path/To/Windows/mpv"
export PATH="$PATH:/mnt/c/Path/To/Windows/mpv"
export FPATH="<path_to_eza>/completions/zsh:$FPATH"
...
alias codefolder='mkdir $1 && code $1/'
# Add this to your ~/.bashrc or ~/.zshrc
alias pythinstall='install_and_activate_venv'

install_and_activate_venv() {
    if [ -z "$1" ]; then
        echo "Usage: pythinstall <package-name>"
    else
